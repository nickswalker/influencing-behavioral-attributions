...
def sample_attr(inits, d, goal_dist, x, grid, ens, w, goal_region, max_effort=100):
    ...
    def batch_min_div(nodes, goal):
        ...
        print(f"{kl.min():.2f}, {together[2].min()} || {together[1][scored.argmin()]:.2f}, {together[2][scored.argmin()]} => {scored.min():.2f}")
        return scored.T
...
if __name__ == '__main__':
    ...
    _, demo_data, _ , _= process_turk_files([ f"data/{x}.csv" for x in ["pilot1", "active1", "active2", "mdn_active1", "mdn_active2"]])
    ...
    """
    opt = [(10, 9), (11, 9), (12, 9), (13, 9), (14, 9), (15, 9), (16, 9), (17, 9), (18, 9), (19, 9), (19, 8), (20, 8), (20, 7), (20, 8), (20, 9), (21, 9), (21, 8), (21, 9), (21, 10), (22, 10), (22, 11), (22, 12), (23, 12), (23, 13), (22, 13), (21, 13), (20, 13), (20, 12), (21, 12), (21, 11), (22, 11), (23, 11), (24, 11), (24, 12), (24, 13), (25, 13), (25, 12), (25, 11), (25, 10), (25, 9), (26, 9), (26, 10), (26, 11), (26, 12), (27, 12), (27, 11), (27, 10), (27, 9), (27, 8), (26, 8), (25, 8), (25, 7), (25, 8), (25, 9), (25, 10), (24, 10), (23, 10), (22, 10), (21, 10), (20, 10), (20, 11), (20, 12), (19, 12), (19, 11), (19, 10), (19, 9), (18, 9), (17, 9), (16, 9), (15, 9), (14, 9), (13, 9), (12, 9), (11, 9), (10, 9)]
    print("TSK", trajectory_cost(bedroom, grid, opt))

    g0 = sample_attr([opt], 0, goal_dist, x_b, grid, ens,IG, bedroom)
    print("G0", trajectory_cost(bedroom, grid, g0), g0)

    g0_inv = sample_attr([opt], 0, inv_goal_dist,x_b, grid, ens, IG, bedroom)
    print("G0 inv", g0_inv)
    ...
    g0_bal = sample_attr([opt], 0, goal_dist,x_b, grid, ens, 200.0, bedroom)
    print("G0 bal", trajectory_cost(bedroom, grid, g0_bal), g0_bal)



    #g1 = sample_attr(demo_trajs, 1, goal_dist, x_b, grid, ens,IG, bedroom)
    #print("G1", trajectory_cost(bedroom, grid, g1), g1)

    #g1_inv = sample_attr(demo_trajs, 1, inv_goal_dist, x_b, grid, ens, IG, bedroom)
    #print("G1 inv", trajectory_cost(bedroom, grid, g1_inv), g1_inv)

    #g1_bal = sample_attr([opt], 1, goal_dist,x_b, grid, ens, 39.5, bedroom, max_effort=100)
    #print("G1 bal", trajectory_cost(bedroom, grid, g1_bal), g1_bal)



    #g2 = sample_attr(demo_trajs, 2, goal_dist, x_b, grid, ens,IG, bedroom, max_effort=40)
    #print("G2", trajectory_cost(bedroom, grid, g2), g2)

    #g2_inv = sample_attr(demo_trajs, 2, inv_goal_dist,x_b, grid, ens, IG, bedroom)
    #print("G2 inv", trajectory_cost(bedroom, grid, g2_inv), g2_inv)

    #g2_bal = sample_attr(demo_trajs, 2, goal_dist,x_b, grid, ens, 300.0, bedroom)
    #print("G2 bal", trajectory_cost(bedroom, grid, g2_bal), g2_bal)


    print("TEST DOMAIN")
    grid, bedroom = load_map("interface/assets/test.tmx")
    featurizer = partial(trajectory_features, bedroom, grid)
    TrajectoryNode.featurizer = featurizer
    """
    ...
    print("better", trajectory_cost(bedroom, grid, better_opt), better_opt)
    """
    opt = [(20, 10), (19, 10), (18, 10), (17, 10), (16, 10), (15, 10), (15, 11), (14, 11), (14, 12), (14, 13), (14, 14), (13, 14), (13, 13), (12, 13), (12, 12), (13, 12), (13, 11), (12, 11), (12, 10), (12, 9), (13, 9), (14, 9), (14, 8), (14, 7), (13, 7), (13, 8), (12, 8), (12, 7), (12, 6), (11, 6), (11, 7), (11, 8), (11, 9), (10, 9), (10, 8), (10, 7), (9, 7), (9, 8), (9, 9), (9, 10), (8, 10), (8, 9), (8, 8), (8, 7), (7, 7), (6, 7), (6, 8), (7, 8), (7, 9), (7, 10), (7, 11), (6, 11), (6, 10), (6, 9), (5, 9), (5, 10), (5, 11), (4, 11), (4, 10), (4, 9), (3, 9), (3, 10), (3, 11), (3, 12), (4, 12), (5, 12), (6, 12), (7, 12), (7, 13), (8, 13), (8, 12), (8, 11), (9, 11), (9, 12), (9, 13), (10, 13), (10, 12), (10, 11), (11, 11), (11, 10), (12, 10), (13, 10), (14, 10), (15, 10), (16, 10), (17, 10), (18, 10), (19, 10), (20, 10)]
    print("TSK", trajectory_cost(bedroom, grid, opt))
    ...
    #g0_bal = sample_attr([opt], 0, goal_dist,x_b, grid, ens, 400.0, bedroom)
    #print("G0 bal", trajectory_cost(bedroom, grid, g0_bal), g0_bal)



    #g1 = sample_attr([opt], 1, goal_dist, x_b, grid, ens,IG, bedroom)
    #print("G1", trajectory_cost(bedroom, grid, g1), g1)

    #g1_inv = sample_attr([opt], 1, inv_goal_dist,x_b, grid, ens, IG, bedroom)
    #print("G1 inv", trajectory_cost(bedroom, grid, g1_inv), g1_inv)

    #g1_bal = sample_attr([opt], 1, goal_dist,x_b, grid, ens, 84.0, bedroom, max_effort=200)
    #print("G1 bal", trajectory_cost(bedroom, grid, g1_bal), g1_bal)


    #g2 = sample_attr([opt], 2, goal_dist, x_b, grid, ens,IG, bedroom, max_effort=70)
    #print("G2", trajectory_cost(bedroom, grid, g2), g2)

    #g2_inv = sample_attr([opt], 2, inv_goal_dist,x_b, grid, ens, IG, bedroom)
    #print("G2 inv", trajectory_cost(bedroom, grid, g2_inv), g2_inv)

    #g2_bal = sample_attr([opt], 2, goal_dist,x_b, grid, ens, 250.0, bedroom)
    #print("G2 bal", trajectory_cost(bedroom, grid, g2_bal), g2_bal)